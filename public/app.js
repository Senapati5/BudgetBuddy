...
async function fetchUserData() {
    ...
    try {
        ...
        localStorage.setItem('email', data.email); // Storing email
        localStorage.setItem('mobile', data.mobile); // Storing mobile number
...
function showProfileModal() {
    ...
    const email = localStorage.getItem('email'); // Fetching email
    const mobile = localStorage.getItem('mobile'); // Fetching mobile number
    ...
    console.log("Email:", email);  // Log to see if email is stored
    console.log("Mobile:", mobile); // Log to see if mobile is stored
    ...
    document.getElementById("modal-email").textContent = email ? email : 'Email not available'; // Display email
    document.getElementById("modal-mobile").textContent = mobile ? mobile : 'Mobile not available'; // Display mobile
